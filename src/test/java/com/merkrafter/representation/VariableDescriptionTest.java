...
class VariableDescriptionTest {
  ...
  /**
   * A variable description should NOT be considered equal to another one if they have different
   * names.
   */
  @Test
  ...
  /**
   * A variable description should be considered equal to another one even if they have different
   * types.
   */
  @Test
