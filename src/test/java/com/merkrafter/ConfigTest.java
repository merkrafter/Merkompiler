...
class ConfigTest {
  ...
  /**
   * The fromArgs method should be able to extract the input file name correctly. It should not set
   * the verbosity nor the output file name.
   *
   ...
   * whether the long or short argument was used or whether it was specified before or after the
   * input file.
   *
   * @throws ArgumentParserException if the arguments can not be parsed; should not happen
   */
  ...
  @ValueSource(
      strings = {"-v Test.java", "--verbose Test.java", "Test.java -v", "Test.java --verbose"})
   ...
   * whether the long or short argument was used, it was assigned using = or not or whether it was
   * specified before or after the input file.
   *
   * @throws ArgumentParserException if the arguments can not be parsed; should not happen
   */
  @ParameterizedTest
  ...
  /**
   * The fromArgs method should be able to extract the compiler stage "scanning" while ignoring the
   * case.
   *
   * @throws ArgumentParserException if the arguments can not be parsed; should not happen
   */
  ...
  /**
   * The fromArgs method should be able to extract the compiler stage "parsing" while ignoring the
   * case.
   *
   * @throws ArgumentParserException if the arguments can not be parsed; should not happen
   */
  ...
  // {short, long} x {before input file, after input file}
  @ValueSource(
      strings = {"-g Test.java", "--graphical Test.java", "Test.java -g", "Test.java --graphical"})
