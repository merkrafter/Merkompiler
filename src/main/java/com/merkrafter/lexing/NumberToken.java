...
public class NumberToken extends Token {
   ...
   ***************************************************************/
  public NumberToken(
      final long number, @NotNull final String filename, final long line, final int position) {
  ...
  /**
   * Two NumberTokens are equal if both have the type NumberToken and their numbers, line numbers,
