...
public class ActualProcedureDescription extends ObjectDescription implements ProcedureDescription {
  // ATTRIBUTES
  // ==============================================================
  @NotNull private final Type returnType;
  @NotNull private final List<VariableDescription> paramList;
  @NotNull private final SymbolTable symbols;
  @Nullable private Statement statements;
   ...
   * valid objects.
   ***************************************************************/
  public ActualProcedureDescription(
  ...
  /**
   * Returns whether this ProcedureDescription is equal to o. For this to happen, o must be a
   * ProcedureDescription as well. Also, both must have the same name and their parameter lists must
   * have the same types in the same order. This behavior comes from a caller's view where only the
   * name and parameters of certain types are given.
   *
  ...
  public boolean equals(@NotNull final Object o) {
    ...
    for (int i = 0; i < numParams; i++) {
      ...
      if (thisParam != null && thatParam != null && thisParam.getType() != thatParam.getType()) {
        return false;
      }
    }
    return true;
