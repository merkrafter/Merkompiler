 ...
 * @author merkrafter
 ***************************************************************/
public class AssignmentNode extends AbstractStatementNode implements SSATransformableStatement {
    // ATTRIBUTES
    //==============================================================
    @NotNull
    ...
    /**
     * Assigns the operand generated by the Expression to the variable.
     *
     * @param baseBlock unused, as no instruction is generated
     * @param joinBlock block that phi instructions are inserted into
     */
    @Override
    public void transformToSSA(@NotNull final BaseBlock baseBlock,
                               @Nullable final JoinBlock joinBlock) {
        if (value instanceof SSATransformableExpression) {
            final SSATransformableExpression ssaValue = (SSATransformableExpression) value;
