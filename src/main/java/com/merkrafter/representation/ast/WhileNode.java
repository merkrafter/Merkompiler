...
public class WhileNode extends AbstractStatementNode {
  ...
  @NotNull private final Statement loopBody;
  ...
  public WhileNode(
      ...
      @NotNull final Statement loopBody,
  ...
  /**
   * Two WhileNodes are considered equal if their conditions and children are non-null and are equal
  ...
  public boolean isCompatibleToType(final @NotNull Type type) {
    ...
    return super.isCompatibleToType(type)
        && (loopBody.isCompatibleToType(type) || !loopBody.hasReturnStatement());
  }
}
